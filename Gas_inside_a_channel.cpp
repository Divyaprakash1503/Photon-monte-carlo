//gas inside a channel // final//Parabolic Temperature profile
#include <iostream>
#include <cmath>
#include <cstdlib>
#include <ctime>
...
int main() {
	...
	double P= ((N*0.005)+(cell*0.005))/2;
		...
		cell=S;
            ...
            double T = 500 + (2000 * P) - (2000 * pow(P, 2));
